...
--progstring=bc5acc
--***********************************
--Comments: Last update Aom 29-12-2558
...
(
	...
	BuyPricePoint SMALLINT DEFAULT 2,
	BranchVatNo VARCHAR(10),
	BranchName VARCHAR(255)	
	PRIMARY KEY(CompanyName)
);
--create index IDX_ISCODE ON bcconfigurations(iscode);
UPDATE BCConfigurations SET BuyPricePoint = PricePoint WHERE BuyPricePoint IS NULL OR BuyPricePoint = '';
...
-- ************** POS **********
	...
	IsBranch SMALLINT DEFAULT 0,--0=สำนักงานใหญ่ 1=สาขา 
    BranchVatNo VARCHAR(10),-- ตาม ภพ. 20
    BranchName VARCHAR(255)	
    PRIMARY KEY(CODE)
);
...
--For AIS
	...
	CouponNo varchar(50),
    RedeemNo varchar(50),
	DistChannel	VARCHAR(20),
	OrderChannel	VARCHAR(20),
	CarLicense VARCHAR(30),
	RedeemAmount MONEY DEFAULT 0.0,
	SCGID Varchar(20)--
...
ALTER TABLE BCARINVOICE ALTER COLUMN RedeemNo varchar(50);
...
(
	...
	PaymentType	SMALLINT DEFAULT 0, --0=เงินสด 1=บัตร 2=เช็ค 3=เงินโอน 4=เงินสดย่อย 5=เงินเกินพัก 6=เงินเกินหัก 7=รายได้อื่นๆ 8=ค่าใช้จ่ายอื่นๆ 9 = คืนเงินรับล่วงหน้า, 10=รับคูปอง
...
(
	...
	PrintCount SMALLINT DEFAULT 0, -- Count Print form -- A-20030923
	ismanualkey	SMALLINT DEFAULT 0,
...
(
	...
	TaxID	VARCHAR(20)	,
	IsBranch SMALLINT DEFAULT 0,--0=สำนักงานใหญ่ 1=สาขา 
    BranchVatNo VARCHAR(10),-- สาขาที่ ตาม ภพ. 20		
...
(
	...
	SALEPRICE	MONEY DEFAULT 0.0,
	DISCOUNTWORD	VARCHAR(35)	,
	FromItemType VARCHAR(10),
	TOITEMTYPE VARCHAR(10),
	FROMCOLOR VARCHAR(10),
	TOCOLOR VARCHAR(10),
	FROMCATEGORY VARCHAR(10),
	TOCATEGORY VARCHAR(10),
	FROMBRAND VARCHAR(10),
	TOBRAND VARCHAR(10),
	CreatorCode VARCHAR(10),
	CreateDateTime DATETIME,
	LastEditorCode VARCHAR(10),
...
(
	...
	CouponType Varchar(20),--Coupon or Redeem
	AmountUsed Money default 0.0,
...
(
	...
	SCGID Varchar(20),--
	CouponType Varchar(20),--Coupon or Redeem
	CouponStatus	smallint default 0,--1 Used
	Refdocno	Varchar(20),--Reference to Invoice No
	InvoiceDate	DateTime,--Reference to Invoice date
	Amountused	Money default 0.0,--Use amount
...
CREATE  INDEX IDX_ACouponMaster_1 ON BCACouponMaster(ArCode);
CREATE  INDEX IDX_ACouponMaster_2 ON BCACouponMaster(ArCode,CouponCode);

create table BCCouponTypeAcc
(
	ROWORDER INT NOT NULL IDENTITY(0,1),
	Code Varchar(20) not null,
	Name VARCHAR(255),
...
update bcchqin set ismanualkey = 0 where ismanualkey is null;
update bcchqout set ismanualkey = 0 where ismanualkey is null;
