...
(
	...
	ColText	VARCHAR(100), -- ชื่อ Column
...
(
	...
	StartTransport	VARCHAR(200), --จุดเริ่มต้นขนส่ง
	StopTransport	VARCHAR(200) --ปลายทางขนส่ง
    PRIMARY KEY(Code)
);
...
(
	...
	DebtLimit1	MONEY DEFAULT 0.0,	-- ยอดวงเงิน
	...
	DocPicRefFile1	VARCHAR(100),	-- เอกสารอ้างอิง 1
	DocPicRefFile2	VARCHAR(100), -- เอกสารอ้างอิง 2
...
-- ************** POS **********
	...
	SumOfValue1	MONEY DEFAULT 0.0, -- ยอดเงินสะสม
	SumOfValue2	MONEY DEFAULT 0.0, -- ยอดเงินสะสม
-- ************** POS **********
...
(
	...
	DocNo	VARCHAR(20) NOT NULL,
	DocDate	DATETIME,
	MyDescription	VARCHAR(200), -- หมายเหตุในการออกใบตรวจนับ
	ResultDesc	VARCHAR(200), -- หมายเหตุผลการตรวจนับ
...
(
	...
	InspectDesc	VARCHAR(100), -- หมายเหตุผลการตรวจนับ
...
(
	...
	ReturnRemark VARCHAR(100), -- หมายเหุตการรับคืนสินค้า
	...
	AFT_remark	Varchar(100),	--ใช้เฉพาะใน A-FOSS
	...
	OfferedBy		Varchar(100),		--ใช้เฉพาะใน A-FOSS
...
(
	ROWORDER INT NOT NULL IDENTITY(0,1),
	Barcode	VARCHAR(20),
	BarcodeName	VARCHAR(200), -- ชื่อ Barcode
	ItemCode	VARCHAR(25),
	Remark	VARCHAR(255),
	ActiveStatus	SMALLINT DEFAULT 1,
	UnitCode	VARCHAR(10)
...
(
	...
	PayAmount	MONEY DEFAULT 0.0,
	DebtLimitReturn MONEY DEFAULT 0.0, -- ยอดทีคืนวงเงิน Default = SumHomeAmount1
	DebtLimitRetDesc VARCHAR(200), -- หมายเหตุการคืนวงเงิน
	MyDescription	VARCHAR(100),
	TransState 	SMALLINT DEFAULT 0, -- 0 = new transaction 1 = old transaction 
	IsCancel	SMALLINT DEFAULT 0, -- 0=ยังไม่Cancel 1=Cancel
	LineNumber SMALLINT DEFAULT 0,
...
(
	...
	DocDate	DATETIME NOT NULL,
	ArCode	VARCHAR(20),
	Description	VARCHAR(200), -- ให้เป็นอะไร/หมายเหตุ
	LineNumber	SMALLINT DEFAULT 0,
...
(
	...
	Description	Varchar(100),	--รายละเอียดสินค้า
	Qty		Money	DEFAULT 0.0,
	 Price		Money	DEFAULT 0.0,
	 Amount		Money	DEFAULT 0.0,
	 UnitCode		Varchar(10),
